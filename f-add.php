    ...
    <div class="container">
      <div class="row">
        <div class="col s12">
          <h3>食品追加</h3>
          <p>食品を追加します。</p>
          <form action="f-add-do.php" method="POST" class="col s12">
            <div class="input-field col s12">
              <input id="FoodName" class="validate" type="text" name="FoodName" required>
            ...
            <div class="input-field col s12">
              <input id="FoodDescription" class="validate" type="text" name="FoodDescription" required>
