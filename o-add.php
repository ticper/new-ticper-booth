...
<html lang="ja">
  ...
  <body>
    <ul id="d-userc" class="dropdown-content">
      ...
      <li><a href="u-addauser.php">団体ユーザ登録</a></li>
    </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12">
          <h3>団体追加</h3>
          <p>団体を追加します。</p>
          <form action="o-add-do.php" method="POST" class="col s12">
            <div class="input-field col s12">
              <input id="OrgName" class="validate" type="text" name="OrgName" required>
              <label for="OrgName">団体名</label>
            </div>
            <div class="input-field col s12">
              <input id="OrgPlace" class="validate" type="text" name="OrgPlace" required>
              <label for="OrgPlace">団体場所</label>
            </div>
